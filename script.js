...
// const indicators = document.querySelector(".indicatorValues")
...
form.addEventListener("submit", async (e) =>{
     ...
     async function displayAQI(AQI){
          if(AQI.status == 'ok'){
              ...
              aqiCard.style.gap = "12px"
              aqiCard.style.backgroundColor = "#ffffff"
              aqiCard.style.width = "220px"
              aqiCard.style.height = "300px"
              ...
              aqiCard.appendChild(displayPM)
               ...
               displayError("Response is not okay")
          }
